...
class CertificateGeneratorClient:
    """A class for interacting with the certificate_generator app providing high productivity and
    ...
    def __init__(
        ...
        *,
        ...
        """
        CertificateGeneratorClient can be created with an app_id to interact with an existing application, alternatively
